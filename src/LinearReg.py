...
def main(path, input_col, label_col, data_start, data_end):
    ...
    x_train, x_test, y_train, y_test = train_test_split(x[data_start: data_end], y[data_start: data_end], test_size=0.33, random_state=0)
    ...
    for i in range(n_label):
        ...
        print('Multiple Linear Regression Score : ', reg.score(x_test, y_test[:, i]))
...
if __name__ == '__main__':
    main(path='pmsm_temperature_data.csv',
         input_col=["pm", "coolant", "ambient", "i_d", "u_d"],
